...
- Added text-selectability to the main window's status label (`LauncherWindow._status`) to allow users to easily select and copy status messages via mouse or keyboard navigation, matching the accessibility of other informational labels in the app.
