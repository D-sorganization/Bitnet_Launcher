...
- Applied `.setAcceptRichText(False)` to `QTextEdit` widgets across the UI to enforce plain text input and display, preventing HTML formatting issues when users paste content.
