...
- Offloaded synchronous disk I/O (`os.scandir`) in the FastAPI endpoints to a thread pool using `asyncio.to_thread` to prevent blocking the asyncio event loop and improve API concurrency.
