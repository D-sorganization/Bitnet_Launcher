...
- Added dynamic tooltips to dynamically generated `QLabel` instances in form layouts (e.g., Settings Panel) by copying the associated input widget's tooltip, expanding the hover discovery area for jargon explanations.
