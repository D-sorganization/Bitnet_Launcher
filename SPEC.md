...
### UI Improvements
- All inline stylesheets for interactive focusable widgets (like `QTextEdit`) include `outline: none;` alongside custom border properties in their `:focus` pseudo-class rules to prevent overlapping native OS focus rings.
